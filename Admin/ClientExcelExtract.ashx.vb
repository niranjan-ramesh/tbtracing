...
Public Class ClientExcelExtract
    Implements System.Web.IHttpHandler

    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest

        If Not IsNothing(context.Request.Params("clientid")) AndAlso IsNumeric(context.Request.Params("clientid")) Then
            Dim clientID As Integer = Integer.Parse(context.Request.Params("clientid"))

            Dim fileName As String = "ClientData-"

            Using db As New TBTracingEntities
                Dim result = (From query In db.client_Demographic _
                             Where query.ClientID = clientID _
            ...
            Try
                Using wb As New XLWorkbook()
                    ...
                    PopulateDataTable(strSymptoms, 95, dtSymptoms)
                    ...
                    PopulateDataTable(strSkinTest, 95, dtSkinTest)
                    ...
                    PopulateDataTable(strSputim, 95, dtSputum)
                    ...
                    PopulateDataTable(strIgra, 95, dtIGRA)
                    ...
                    PopulateDataTable(strBlood, 95, dtBloodwork)
                    ...
                    PopulateDataTable(strDiagnotic, 95, dtDiagnostic)
                    ...
                    PopulateDataTable(strRisk, 95, dtRisks)
                    ...
                    PopulateDataTable(contacts, 95, dtContactsSrc)
                    PopulateDataTable(identified, 95, dtContactsEnd)
                    ...
                    context.Response.AddHeader("content-disposition", headerDisposition)
            ...
            Catch ex As Exception
                ...
                context.Session.Add("ErrorMessage", "Error Retrieving Client X-Ray Test")
                context.Response.Redirect("~/ErrorPage.aspx", False)
            End Try
        Else
            context.Response.ContentType = "text/plain"
            context.Response.Write("Invalid client id")
        End If
    End Sub
