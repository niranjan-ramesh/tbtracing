...
Partial Public Class Manage
    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessage = If(message = "ChangePwdSuccess", "Your password has been successfully changed.", If(message = "SetPwdSuccess", "Your password has been set.", If(message = "RemoveLoginSuccess", "The account was removed.", [String].Empty)))
    ...
    Protected Sub ChangePassword_Click(sender As Object, e As EventArgs)
        If IsValid Then
            ...
            Try
                If u.ChangePassword(CurrentPassword.Text, NewPassword.Text) Then
                    Response.Redirect("~/Account/Manage?m=ChangePwdSuccess")
                Else
                    ModelState.AddModelError("", "Password Change failed.  Please retry ")
                End If
            Catch ex As Exception
                ModelState.AddModelError("", "Password Change failed: " & Server.HtmlEncode(ex.Message))
                LogHelper.LogError("Error changing password", "Password", ex)
